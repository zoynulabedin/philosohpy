                ...
                <?php 
                    ...
                    while($philosophy_popular_post->have_posts()){
                        ...
                        <section class="popular__meta">
                                <span class="popular__author"><span><?php _e("By"); ?></span> <a href="<?php the_permalink(); ?>"> <??></a></span>
    ...
    <footer class="s-footer">
        ...
        <div class="s-footer__main">
            <div class="row">
               ...
               <?php if(is_active_sidebar( 'footer-newslater' )){
                   dynamic_sidebar( 'footer-newslater' );
               }?>
